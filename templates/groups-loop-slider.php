...
$settings = bp_featured_groups()->get( 'slider-settings' );
...
<ul class="item-list featured-groups-list featured-groups-<?php echo esc_attr( $view ); ?>" <?php bp_groups_slider_data_attributes( $settings );?>">
...
<?php endwhile; ?>
    ...
    <?php bp_featured_groups()->load_slider(); ?>
<?php else : ?>

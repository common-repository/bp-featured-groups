...
<?php if ( bp_has_groups( bp_ajax_querystring( 'groups' ) . '&user_id="0"&include=' . $featured . '&slug=&type=alphabetical' ) ) : ?>
	...
	<?php while ( bp_groups() ) : bp_the_group(); ?>
		...
		<li <?php bp_group_class(); ?>>
			...
			<div class="item">
				...
				<div class="item-meta"><span class="activity" data-livestamp="<?php bp_core_iso8601_date( bp_get_group_last_active( 0, array( 'relative' => false ) ) ); ?>"><?php printf( __( 'active %s', 'bp-featured-groups' ), bp_get_group_last_active() ); ?></span></div>
	...
	<div id="message" class="info">
		<p><?php _e( 'There were no groups found.', 'bp-featured-groups' ); ?></p>
	</div>
